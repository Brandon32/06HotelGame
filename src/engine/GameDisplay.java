...
public class GameDisplay
{
    ...
    public static void create( int width, int height )
    {
        if ( frameInstance == null )
        {
            ...
            {
                robot = new Robot();
                //robot.mouseMove( frameInstance.getX() + frameInstance.getWidth() / 2, frameInstance.getY() + frameInstance.getHeight() / 2 );
            }
    ...
    public static Dimension getBounds()
    {
        if ( frameInstance != null )
        {
            return new Dimension( frameInstance.getWidth(), frameInstance.getHeight() );
        }
        else
        {
            throw new RuntimeException( "display not created" );
