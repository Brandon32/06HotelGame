...
/**
 * Playing field class to manage a virtual graphics display that is larger than the physical display.
 * 
...
{
    /**
     * Draw the playingfield onto the graphics context
     * 
     * @param g2d
     */
    ...
    /**
     * Return the bounds of the playingfield as a rectangle
     * 
     * @return Rectangle
     */
    ...
    /**
     * Check to see it there is a collision with anything on the playing field at the x,y coordinates
     * 
     * @param x
     * @param y
     * @return boolean
