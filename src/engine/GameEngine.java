...
public class GameEngine implements Runnable, GameEventListener
{
    ...
    /**
     * Get the animation thread going. Calls start() once the thread is created and running.
     * 
     * @param game
     */
    public static void start( Game game )
    {
        ...
        {
            /**
             * Create an instance of the game engine, intialize variables and register the game event listener
             */
    ...
    /**
     * Stop the game engine. Will not immediately stop the game engine. It will stop at the beginning of the next frame update.
     * 
     */
    ...
    public void run()
    {
        ...
        /**
         * If we get to this point, it's because running was set to false. In that case, notify the game event manager to quit and exit
         * the thread.
         */
        synchronized ( gameEventList )
        {
    ...
    private void manageGameEvents()
    {
        ...
        while ( true )
        {
            ...
            {
                /**
                 * If the game event list is empty then wait for an event to show up
                 */
                ...
                /**
                 * Check to see if the game engine thread has stopped running the we return
                 */
                if ( !running )
                {
                    return;
